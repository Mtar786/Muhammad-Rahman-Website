...
// Local storage utilities for managing site data
const SiteData = {
    ...
    getPreferences: () => {
        return JSON.parse(localStorage.getItem('sitePreferences') || '{}');
    },
    ...
    // Clear contact messages (admin function)
    clearContactMessages: () => {
        localStorage.removeItem('contactMessages');
        showNotification('Contact messages cleared', 'info');
    }
};

// Initialize site data on load
document.addEventListener('DOMContentLoaded', () => {
    const visitCount = SiteData.incrementVisitCount();
    console.log(`Welcome! This is visit #${visitCount}`);
    
    // Load any saved preferences
    const preferences = SiteData.getPreferences();
...
console.log(`
🚀 Welcome to Tayyib Sheikh's Personal Website!
Built with modern web technologies and stored locally.
Visit count: ${SiteData.getVisitCount()}
`);
